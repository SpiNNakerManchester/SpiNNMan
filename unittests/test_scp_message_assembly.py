...
class TestSCPMessageAssembly(unittest.TestCase):
    def test_create_new_scp_message(self):
        ...
        self.assertEqual(scp_msg.argument_1,1)
        self.assertEqual(scp_msg.argument_2,2)
        self.assertEqual(scp_msg.argument_3,3)
        self.assertEqual(scp_msg.command,scp_msg.Command.CMD_APLX)
        ...
        self.assertEqual(scp_msg.destination_cpu,0)
        self.assertEqual(scp_msg.sequence,0)
