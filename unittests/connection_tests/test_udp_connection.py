import unittest
from spinnman.connections.udp_packet_connections.udp_scp_connection \
    import UDPSCPConnection
...
class TestUDPConnection(unittest.TestCase):
    ...
    def test_setup_new_local_udp_connection(self):
        ...
        connection = UDPSCPConnection(self.localhost,self.localport,self.remotehost,self.remoteport)
    ...
    def test_send_scp_request_to_nonexistent_host(self):
        with self.assertRaises(exc.SpinnmanTimeoutException):
            ...
            remoteport = 11111
            connection = UDPSCPConnection(localhost,localport,remotehost,remoteport)
