...
class Testing_utils(unittest.TestCase):
    ...
    def test_int_to_big_endian(self):
        ba = bytearray(4)
        utils._put_int_in_big_endian_byte_array(ba,0,4294901760)
        hex_string = "FFFF0000"
        hn = hex_string.decode("hex")
        ba2 = bytearray(hn)
    ...
    def test_little_endian_to_int(self):
        ...
        hn = hex_string.decode("hex")
        ba = bytearray(hn)
        ba = utils._get_int_from_little_endian_bytearray(ba,0)
    ...
    def test_little_endian_to_short(self):
        ...
        hn = hex_string.decode("hex")
        ba = bytearray(hn)
        ba = utils._get_short_from_little_endian_bytearray(ba,0)
