...
class EIEIO16BitWithPayloadTimedLowerKeyPrefixDataMessage(
    ...
    """
    Class representing an EIEIO packet containing 16 bit events and payloads,
    where the payloads represent the timestamp of the events, and
    a key prefix to be applied to the lower end of the key
    """
