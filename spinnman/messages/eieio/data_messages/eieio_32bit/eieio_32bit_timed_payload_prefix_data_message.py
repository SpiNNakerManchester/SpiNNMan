...
class EIEIO32BitTimedPayloadPrefixDataMessage(EIEIOWithoutPayloadDataMessage):
    """
    Class representing an EIEIO packet containing 16 bit events with
    a timestamp for the events
    """
