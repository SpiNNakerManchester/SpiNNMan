...
class EIEIO16BitPayloadPrefixUpperKeyPrefixDataMessage(
        EIEIOWithoutPayloadDataMessage):
    """
    Class representing an EIEIO packet containing 16 bit events, a key
    prefix to be applied to the upper end of the key, and a fixed payload
    """
