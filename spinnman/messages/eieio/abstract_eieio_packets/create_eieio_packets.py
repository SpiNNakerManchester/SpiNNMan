...
from spinnman.messages.eieio.buffer_data_objects import \
    eieio_without_payload_data_packet
from spinnman.messages.eieio.buffer_data_objects import \
    eieio_with_payload_data_packet

from spinnman.messages.eieio.command_objects.eieio_command_packet \
    import EIEIOCommandPacket

from spinnman.messages.eieio.buffer_data_objects.eieio_16bit import \
...
def create_command_from_reader(reader):
    """
    Interprets the command packet received and creates the appropriate class
