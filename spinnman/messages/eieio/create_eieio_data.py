...
def _read_16_bit_message(prefix, payload_base, prefix_type, is_time,
    ...
    """
    Returns a packet containing 16 bit elements
    """
...
def _read_16_bit_payload_message(prefix, payload_base, prefix_type,
    ...
    """
    Returns a packet containing 16 bit elements and payload
    """
...
def _read_32_bit_message(prefix, payload_base, prefix_type, is_time,
                         data, offset, eieio_header):
    """
    Returns a packet containing 32 bit elements
    """
    if payload_base is None:
        if prefix is None:
...
def _read_32_bit_payload_message(prefix, payload_base, prefix_type,
                                 is_time, data, offset, eieio_header):
    """
    Returns a packet containing 32 bit elements and payload
    """
    if payload_base is None and not is_time:
        if prefix is None:
...
def read_eieio_data_message(data, offset):
    """
    Reads the content of an EIEIO data message and returns an object identifying
    the data which was contained in the packet
    ...
    from :py:class:`spinnman.messages.eieio.data_messages.eieio_data_message.EIEIODataMessage`
    """
