...
class SCPSDRAMDeAllocRequest(AbstractSCPRequest):
    """ An SCP Request to allocate space in the sdram
    """
    ...
    def __init__(self, x, y, app_id, base_address=None):
        ...
        needs to be dealloced, or none if deallocing via app_id
        ...
        if base_address is not None:
            AbstractSCPRequest.__init__(self,
                ...
                argument_1=
                    app_id << 8 | SCPAllocFreeType.FREE_SDRAM_BY_POINTER.value,
            ...
            AbstractSCPRequest.__init__(self,
                ...
                SCPRequestHeader(command=SCPCommand.CMD_ALLOC),
                argument_1=
                    app_id << 8 | SCPAllocFreeType.FREE_ROUTING_BY_APP_ID.value)
