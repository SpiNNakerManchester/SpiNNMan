...
class SCPMessage (SDPMessage):
    ...
    def __init__(self, packed=None, **kwargs):
        """Contructs a new :py:class:`SCPMessage` object -- overloaded from \
        base class to add new members.
    ...
    def _pack_hdr(self):
        ...
        :return a new spinnMan.sdp.sdp_message.SDP_Message object
        :rtype: spinnMan.sdp.sdp_message.SDP_Message
    ...
    def _unpack_hdr(self, packed):
        ...
        :type packed: str
        :return both a packet header and a payload (if applicable)
        :rtype: dict and payload array
        :raise: None: does not raise any known exceptions
        """
    ...
    def arg1(self):
        ...
        :return: arg1 of this scp message
        :rtype: int or any other type
        :raise: None: does not raise any known exceptions
        """
        return self._arg1
    ...
    def arg2(self):
        ...
        :return: arg2 of this scp message
        :rtype: int or any other type
        :raise: None: does not raise any known exceptions
        """
        return self._arg2
    ...
    def arg3(self):
        ...
        :return: arg3 of this scp message
        :rtype: int or any other type
        :raise: None: does not raise any known exceptions
        """
    ...
    def data(self):
        """Optional payload for the :py:class:`SCPMessage` object --\
           ...
           :return: the data from this scp_message
           :rtype: array
           :raise: None: does not raise any known exceptions
        """
