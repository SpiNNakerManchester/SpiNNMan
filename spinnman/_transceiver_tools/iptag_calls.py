from spinnman.transceiver_tools import _scamp_constants
...
class _IPTagCalls(object):
    ...
    def get_iptag_table_info(self):
        """ Retrieve the number of fixed and transient tags available as well\
            as the default timeout for all transient tags.
