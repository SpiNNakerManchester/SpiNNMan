...
class ReadSV(AbstractSCPRequest):
    ...
    def __init__(self, x, y, variable, size=None):
        ...
        :param size: Amount of data to be read.
            Defaults to the variable's data type's size.
        """
...
class ReadBoardProcess(AbstractMultiConnectionProcess):
    ...
    def __init__(
        ...
        """
        :param eth_x: X coordinate of the ethernet Chip
        :param eth_y: y coordinate of the ethernet Chip
        :param width: Width of the whole Machine
        :param height: Height of the whole Machine
        :param p2p_table: Table to look up routes in
        :param connection_selector:
            How to choose the connection.
        :param core_counter: Plot to show cores
        :param save: Flag to say data should be saved
